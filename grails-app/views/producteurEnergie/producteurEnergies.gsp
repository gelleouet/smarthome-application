...
<body>
	<g:applyLayout name="applicationConfigure">
		...
		<h4>
			<g:form class="aui" action="producteurEnergies">
				<fieldset>
		...
		<app:datatable datatableId="datatable" recordsTotal="${ recordsTotal }">
		    ...
		    <tbody>
		    	<g:each var="bean" in="${ producteurEnergieInstanceList }">
			        <tr>
			            <td><g:link action="edit" id="${bean.id }">${ bean.libelle }</g:link></td>
			            <td>${ bean.nbaction }</td>
			            <td>${ bean.investissement }€</td>
			            <td>${ bean.surface }m²</td>

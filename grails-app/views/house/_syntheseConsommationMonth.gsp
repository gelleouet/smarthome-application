...
<h4><i class="align-middle" data-feather="zap"></i> ${ title ?: 'Consommations mois' }</h4>
...
<g:if test="${ house?.compteur }">
	...
	<div style="text-align:right; font-weight:bold;">
		<g:link class="btn btn-primary" controller="device" action="deviceChart" params="['device.id': house.compteur.id, viewMode: 'month']">

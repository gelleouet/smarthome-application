	...
	<div class="row mt-4">
			  	...
			  	<div class="row">
			  		...
			  		<div class="col-6 text-right">
			  			<h4 class="text-black-50 font-weight-bold">
			  				<g:render template="formatConsommation" model="[value: data.consos.reference, unite: data.type.converter.unite()]"/>
			  			</h4>
			  		</div>
			  	</div>
			  	...
			  	<div class="row">
			  		...
			  		<div class="col-6 text-right">
			  			<h4 class="text-primary font-weight-bold">
			  				<g:render template="formatConsommation" model="[value: data.consos.action, unite: data.type.converter.unite()]"/>
			  			</h4>
			  		</div>
			  	</div>
		...
		<div class="col-8">
			...
			<div class="row ml-4 mr-4" style="margin-top:-40px;">
				...
				<div class="col border-bottom border-right text-center p-2">
					<g:if test="${ (participant?.groupKey?.contains('ELEC') && data.consos.type?.toString() == 'electricite') || 

	...
	<g:applyLayout name="page-default">
		...
		<div class="card flex-fill w-100">
			<div class="card-body">
				...
				<g:render template="/grandDefi/grandDefi2020Model/evolutionUser" model="[data: global, defi: currentDefi, participant: participant]"/>	
			</div>
		</div>
		...
		<div class="card flex-fill w-100">
			<div class="card-body bg-linky">
				...
				<g:render template="/grandDefi/grandDefi2020Model/resultatUser" model="[data: electricite, defi: currentDefi, participant: participant]"/>					
			</div>
		</div>
		...
		<div class="card flex-fill w-100">
			<div class="card-body">
				...
				<g:render template="/grandDefi/grandDefi2020Model/resultatUser" model="[data: gaz, defi: currentDefi, participant: participant]"/>	
			</div>
		</div>
		...
		<div class="card flex-fill w-100">
			<div class="card-body">
				...
				<g:render template="/grandDefi/grandDefi2020Model/resultatUser" model="[data: eau, defi: currentDefi, participant: participant]"/>	
			</div>
		</div>

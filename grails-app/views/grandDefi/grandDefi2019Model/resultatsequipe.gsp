	...
	<g:applyLayout name="page-default">
		...
		<div class="card flex-fill w-100">
			<div class="card-body">
				...
				<g:render template="/grandDefi/grandDefi2019Model/resultatEquipe" model="[data: global, defi: currentDefi]"/>	
			</div>
		</div>
		...
		<div class="card flex-fill w-100">
			<div class="card-body">
				...
				<g:render template="/grandDefi/grandDefi2019Model/resultatEquipe" model="[data: electricite, defi: currentDefi]"/>					
			</div>
		</div>
		...
		<div class="card flex-fill w-100">
			<div class="card-body">
				...
				<g:render template="/grandDefi/grandDefi2019Model/resultatEquipe" model="[data: gaz, defi: currentDefi]"/>	
			</div>
		</div>

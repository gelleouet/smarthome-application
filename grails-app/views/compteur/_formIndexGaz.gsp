...
<div class="form-group">
	...
	<div class="row">
		...
		<div class="col">
			...
			<small class="text-muted">Part index en dm3</small>
		</div>
	</div>
...
<div class="form-group required">
	...
	<g:field type="number decimal" name="param1" value="${ (command.param1 ?: (command.device.metadata('coefConversion')?.value ?: defaultCoefGaz)) }" class="form-control" required="true" readonly="${ modeAdmin ? 'false' : 'true' }"/>

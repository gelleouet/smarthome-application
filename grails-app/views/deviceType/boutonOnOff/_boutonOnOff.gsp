<div>
	<g:form controller="device" >
		...
		<g:if test="${ value == 1 }">
			<g:actionSubmit value="OFF" class="aui-button confirm-button" action="publicInvokeAction"/>
			<span class="aui-lozenge aui-lozenge-success" style="font-size: large;">ON</span>
		</g:if>
		<g:else>
			<g:actionSubmit value="ON" class="aui-button confirm-button" action="publicInvokeAction"/>

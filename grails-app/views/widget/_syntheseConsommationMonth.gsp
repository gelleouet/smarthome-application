...
<h4><g:if test="${ icon }"><app:icon name="${ icon }" lib="${ iconLib }"/></g:if> ${ title ?: 'Consommations mois' }</h4>
			...
			<div class="col-4">
				...
				<div class="mt-4">
					...
					<div class="synthese-content">
						...
						<h6 style="mt-1">Dernier relevé : ${ app.formatTimeAgo(date: compteur.dateValue) }</h6>

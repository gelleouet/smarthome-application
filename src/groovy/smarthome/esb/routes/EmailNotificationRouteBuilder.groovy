 ...
 *
 */
class EmailNotificationRouteBuilder extends RouteBuilder {

	private static final log = LogFactory.getLog(this)
	
	final String EXCHANGE = "amq.direct"
	final String QUEUE = "smarthome.automation.notificationService.sendEmail"
	...
	void configure() throws Exception {
		...
		.setHeader("to").groovy("body.email")
		// template mail
		.to("velocity:/smarthome/esb/routes/NotificationMailTemplate.vm")
		// envoi mail SMTP
		.setHeader("subject", constant("Notification événement"))
